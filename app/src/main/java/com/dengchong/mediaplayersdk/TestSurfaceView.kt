...
class TestSurfaceView(context: Context, attributeSet: AttributeSet?) : GLSurfaceView(context, attributeSet) {

    init {
        setEGLContextClientVersion(3)
        setRenderer(TestRender(context))
    }
}

class TestRender(val context: Context) : GLSurfaceView.Renderer {
